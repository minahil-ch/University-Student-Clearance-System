        ...
        {isOpen && (
          <>
            ...
            <motion.div 
              ...
              className="absolute right-0 mt-4 w-80 md:w-96 bg-white dark:bg-slate-900 rounded-[2rem] shadow-2xl border border-slate-100 dark:border-slate-800 overflow-hidden z-50"
            >
