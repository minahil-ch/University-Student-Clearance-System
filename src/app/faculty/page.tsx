      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Select your academic department portal, then sign in with your staff account.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {departments.map((dept) => (
            <button
              key={dept}
              onClick={() => router.push(`/login/staff?dept=${encodeURIComponent(dept)}`)}
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mt-1">Academic clearance management portal</p>
            </button>
          ))}
        </div>
      </div>
