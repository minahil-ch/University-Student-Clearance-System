...
import { CheckCircle2, Download, Search, User } from "lucide-react"
import { Input } from "@/components/ui/Input"
import { toast } from "sonner"

export default function ClearedStudentsPage() {
  ...
  const exportToCSV = () => {
    const headers = ["Full Name", "Reg No", "Email", "Department", "Cleared Date"]
    ...
    link.setAttribute("download", `cleared_students_${dept}.csv`)
