        ...
        <header className="flex flex-col xl:flex-row xl:items-end justify-between gap-8 mb-12">
          <div>
            <div className="flex items-center gap-3 mb-2">
               <Badge className="bg-primary/10 text-primary border-none rounded-lg px-3 py-1 text-[10px] font-black uppercase tracking-widest">Enterprise Ready</Badge>
               <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Session 2024-25 Audit</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter italic text-primary">CUI <span className="text-primary">Clearance System</span></h1>
          ...
          <div className="flex items-center gap-4">
             <Button 
               ...
               variant="outline"
               className="h-14 px-6 rounded-2xl border-slate-200 font-black uppercase text-[10px] tracking-widest gap-2"
             >
             ...
             <Button 
               ...
               className="h-14 px-8 rounded-2xl bg-slate-900 text-white hover:bg-black font-black uppercase text-[10px] tracking-widest shadow-2xl shadow-black/20 gap-3 min-w-[200px]"
             >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2">
            <Card className="glass-card border-none rounded-[2.5rem] shadow-2xl overflow-hidden">
               <CardHeader className="p-8 border-b border-slate-100 flex items-center justify-between">
                  <div>
                    <CardTitle className="text-xl font-black uppercase tracking-tighter">Department Efficiency Matrix</CardTitle>
                    <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mt-1">Real-time clearance velocity tracking</p>
                  </div>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-left">
                       <thead className="bg-slate-50/50">
                         <tr>
                           <th className="px-8 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400">Department Node</th>
                           <th className="px-8 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400 text-center">Clearance Rate</th>
                           <th className="px-8 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400 text-right">Operational Load</th>
                         </tr>
                       </thead>
                            ...
                            <tr key={i} className="hover:bg-slate-50/40 transition-all">
                               <td className="px-8 py-6">
                                  <div className="flex items-center gap-4">
                                     ...
                                     <span className="font-black text-slate-900 uppercase text-xs tracking-tight">{dept.name}</span>
                                  </div>
                               </td>
                               <td className="px-8 py-6">
                                  <div className="flex flex-col items-center gap-2">
                                     ...
                                     <span className="text-[10px] font-black text-primary italic">{dept.clearanceRate}% Efficiency</span>
                                  </div>
                               </td>
                               <td className="px-8 py-6 text-right">
                                  <div className="flex flex-col items-end">
                                     <span className="text-sm font-black text-slate-900">{dept.total} Total</span>
                                     <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">{dept.pending} Pending Reviews</span>
                                  </div>
                               </td>
                            </tr>
                          ))}
          ...
          <div className="xl:col-span-1 space-y-8">
             <Card className="glass-card border-none rounded-[2.5rem] shadow-2xl overflow-hidden">
                <CardHeader className="p-8 bg-primary text-white">
                   <div className="flex items-center gap-4">
                      ...
                      <div>
                         <CardTitle className="text-xl font-black uppercase tracking-tighter italic leading-none">Batch Distribution</CardTitle>
                         <p className="text-[10px] font-black uppercase tracking-widest text-white/60 mt-2 italic">Student Census by Session</p>
                      </div>
                   </div>
                </CardHeader>
                <CardContent className="p-8 space-y-4">
                   {data.batchDistribution.map((batch: any, i: number) => (
                     <div key={i} className="flex items-center justify-between p-5 bg-slate-50 rounded-[1.5rem] hover:bg-white hover:shadow-lg transition-all border border-slate-100/50">
                        <div className="flex items-center gap-4">
                           <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center font-black text-primary text-xs shadow-sm">
                              {batch.batch.slice(-2)}
                           </div>
                           <span className="font-black text-slate-900 uppercase text-xs">Session {batch.batch}</span>
                        </div>
                        <span className="text-lg font-black text-primary">{batch.count}</span>
                     </div>
                   ))}
                </CardContent>
             </Card>
             ...
             <Card className="p-10 bg-indigo-600 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden group cursor-pointer" onClick={exportToPDF}>
                ...
                <h4 className="text-2xl font-black uppercase tracking-tighter italic">Generate Audit Report</h4>
                ...
                <div className="mt-8 flex items-center gap-3 font-black text-[10px] uppercase tracking-widest text-white">
